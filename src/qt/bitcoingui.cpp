/*
 * Qt4 GorillaBucks GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The GorillaBucks Developers 2011-2013
 */
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GorillaBucks address"));
    ...
    aboutAction->setToolTip(tr("Show information about GorillaBucks"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for GorillaBucks"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &GorillaBucks"), this);
    toggleHideAction->setToolTip(tr("Show or hide the GorillaBucks window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/GorillaBucks_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/GorillaBucks_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    notificator = new Notificator(tr("GorillaBucks-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GorillaBucks network", "", count));
}
