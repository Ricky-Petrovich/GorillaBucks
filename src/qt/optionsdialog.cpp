        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start GorillaBucks on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start GorillaBucks after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the GorillaBucks client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show GorillaBucks addresses in the transaction list"));
