...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BUCKS");
    case mBTC: return QString("mBUCKS");
    case uBTC: return QString::fromUtf8("μBUCKS");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("BUCKS");
    case mBTC: return QString("Milli-BUCKS (1 / 1,000)");
    case uBTC: return QString("Micro-BUCKS (1 / 1,000,000)");
    default: return QString("???");
    }
}
